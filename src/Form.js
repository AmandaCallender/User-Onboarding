      ...
      <Form>
        ...
        <label>
          ...
          <Field as="select" name="role">
            ...
            <option value="Support">Healer</option>
            <option value="Tank">Tank</option>
            <option value="Assassin">DPS</option>
          </Field>
        </label>
        <label>
          Terms of Service:
  ...
  validationSchema: yup.object().shape({
    ...
    password: yup
      ...
      .matches(
        ...
        {
          message:
            "Password needs a minimum eight characters, at least one letter, one number and one special character ",
        },
      ),
